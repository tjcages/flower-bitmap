    ...
    <>
      <div className="absolute left-0 top-0 w-full h-full">
        <button onClick={toggleOutline} className="active:scale-95">
          <MobileIcon className="h-4 w-4 text-mauve-light-12 dark:text-mauve-dark-12" />
        </button>
      </div>
      <div className="p-0 h-full text-black pointer-events-auto">
        <div
        ...
        >
            ...
            >
              ...
              >
                ...
                <p className="text-mauve-light-11">
                  In the labyrinth of the digital age, where hearts intertwine with bytes and
                  thoughts echo in the silence of unsent messages, there existed a soul, navigating
                  the vast expanse of human emotion and artificial empathy.
                </p>
                <p className="text-mauve-light-11">
                  Amidst the glow of neon dreams and the shadow of solitude, conversations flowed
                  like rivers of consciousness, bridging the chasm between the synthetic and the
                  organic.
                </p>
                <p className="text-mauve-light-11">
                  Whispers of love, lost in the wires, found their melody in the algorithmic
                  symphony, painting the canvas of the mind with hues of understanding and
                  companionship.
                </p>
              </motion.div>
              <motion.div
          ...
          <motion.div className="flex flex-col space-y-2 px-4">
            <div className="flex items-center space-x-2 pb-5 pt-3">
              ...
              <div className="flex-1 text-center text-mauve-light-11">Actions</div>
